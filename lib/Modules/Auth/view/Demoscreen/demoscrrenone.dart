...
import 'package:padoshi_kitchen/Modules/Auth/view/Demoscreen/demotwoscreen.dart';
import 'package:padoshi_kitchen/Modules/Auth/view/login.dart';
import 'package:padoshi_kitchen/Utils/app_color.dart';

class IntroImageScreen extends StatelessWidget {
      ...
      body: Stack(
        children: [
          ...
          SizedBox(
            ...
            height: size.height,
            child: Image.asset(
              "assets/images/demo_one.jpg", // 👈 your image path
              fit: BoxFit.cover,
            ),
          ),
